...
export default function CollabDiscoverAllPage() {
  ...
  useEffect(() => {
    ...
    const fetchProfiles = async () => {
      ...
      console.log("[discover-all] error", error?.message ?? null);
      if (!active) return;
  ...
  return (
    <CollabLayout
      ...
      subtitle="Search the entire network and start collaborations."
    >
      <div className="mb-6">
        <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-slate-800 bg-slate-900/60 px-4 py-3">
          ...
          <input
            ...
            placeholder="Search all users by name, skills, or email"
